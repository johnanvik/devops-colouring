...
# Actions This Sprint
## Setup
1. Add a "Container" label to any issues that still in Testing to represent the move to using containers.
   - Remove the "Hacked" label, if it exists.
1. Set the status of the issues in Testing to Production.
1. Your role has changed to Developer.
   - Read the Developer role description(s), if you are not already cross trained in this role.
